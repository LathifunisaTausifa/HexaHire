    ...
    return (
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="w-64 bg-gray-800 text-white p-6">
                <h2 className="text-2xl font-bold mb-6">HexaHire</h2>
                <ul>
            ...
            <div className="flex-1 p-10 overflow-auto">
                <h1 className="text-4xl font-bold mb-4">Welcome to HexaHire!</h1>
                <p className="text-gray-600">
                    This is your recruiting dashboard where you can manage candidates, job postings, and settings.
                </p>

                {/* User Banner */}
                <div className="bg-white shadow-md rounded-lg mt-6 p-6 flex items-center justify-between">
                    {/* Profile Section */}
                    <div className="flex items-center">
                        ...
                        <div className="ml-6">
                            ...
                            <p className="text-gray-500">Senior Recruiter</p>
                            <div className="mt-4">
                                <p className="text-gray-600">
