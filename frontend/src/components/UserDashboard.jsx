        ...
        <div>
            ...
            <div className="flex h-screen bg-gray-100">
                ...
                <div className="flex-1 p-10 overflow-auto">
                    ...
                    {/* User Banner */}
                    <div className="bg-white shadow-md rounded-lg mt-6 p-6 flex items-center justify-center border-2 border-gray-300">
                        {/* Profile Section */}
                        <div className="flex items-center">
                            ...
                            <div className="ml-6 ">
                                ...
                                <p className="text-gray-500 text-lg">Full stack web Developer Intern at Sona Comstar | Canva designer | Power BI analyst | Final year student | B.Tech IT | Anna University</p>
                                <a className="text-blue-600 font-medium">www.mylinkedina.com</a>
                                <div className="mt-4">
                                    <p className="text-gray-600">
                                        B.Tech , <span className="font-bold text-blue-600">Anna University</span>
                                    </p>
                                    <p className="text-gray-600">
                                        Percentage : <span className="font-bold text-green-600">86%</span>
                                    </p>
                                    <p className="text-gray-600">
                                        Experience : <span className="font-bold text-red-600"> 2 Year, Software Developer, Kryptos Technologies</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-8">
                        <label className="block text-2xl font-bold  text-gray-700 mb-2" htmlFor="areaOfInterest">
                            Candidate Area of Interest:
                        </label>
                        <select
                            id="areaOfInterest"
                            className="p-3 border border-gray-300 shadow-md rounded-md w-full text-gray-700"
                            value={selectedInterest}
                            onChange={handleSelectChange}
                        >
                            <option value="" className="pr-4" >Select an area of interest</option>
